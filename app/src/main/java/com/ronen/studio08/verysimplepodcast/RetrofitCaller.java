...
/**
 * Created by studio08 on 6/2/2016.
 */
public class RetrofitCaller {
    ...
    interface OnRetrofitCalledListener {
        void retrofitCalled(List<SampleFeed> sampleFeedList);
    }
    ...
    public void addFeedToSQLite(final String feedUrl) {
            ...
            public void onResponse(Call<RSS> call, Response<RSS> response) {
                ...
                if (rss != null) {
                    ...
                    try {
                        ...
                        Toast.makeText(context, R.string.error_feed, Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            }
    ...
    public void sampleFeedRetrofitCaller() {
        ...
        call.enqueue(new Callback<List<SampleFeed>>() {
            ...
            public void onResponse(Call<List<SampleFeed>> call, Response<List<SampleFeed>> response) {
                ...
                sampleFeedList = response.body();

                OnRetrofitCalledListener listener = (OnRetrofitCalledListener) new AddFeedActivity();
                listener.retrofitCalled(response.body());
